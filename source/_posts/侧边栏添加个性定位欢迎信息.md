...
categories:
  - 网站开发
cover: https://image.rusin7.com/file/hexo/cover/z7qOAkod.webp
top_img: https://image.rusin7.com/file/hexo/cover/z7qOAkod.webp
updated: '2026-06-03T17:27:37.361+08:00'
...
在 `_config.anzhiyu.yml` （或其他主题）主题配置文件下 `inject` 配置项中的 `bottom` 引入 `welcome.js`。
...
确认 `_config.anzhiyu.yml` （或其他主题）主题配置文件下 `aside` 配置项中的 `card_announcement` 是否开启，配置参考：
